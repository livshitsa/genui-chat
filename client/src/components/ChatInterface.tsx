    ...
    return (
        <div className="relative h-screen w-screen overflow-hidden bg-slate-950 font-sans selection:bg-blue-500/30">
            ...
            <div className="absolute inset-0 z-0">
                ...
                {activeComponentCode ? (
                    <div className={`w-full h-full transition-all duration-700 ease-out perspective-1000 ${isChatExpanded ? 'opacity-20 scale-[0.95] blur-sm translate-y-4' : 'opacity-100 scale-100 blur-0 translate-y-0'}`}>
                        <div className={`relative w-full h-full transition-transform duration-700 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
                            ...
                            {/* Back Face (Code) */}
                            <div className="absolute inset-0 backface-hidden rotate-y-180 bg-slate-900 overflow-auto p-8">
                                <div className="max-w-4xl mx-auto">
                                    <h3 className="text-slate-400 text-sm font-medium uppercase tracking-wider mb-4 sticky top-0 bg-slate-900 py-2 border-b border-slate-800">
            ...
            <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-end items-center pb-6 sm:pb-10">
                ...
                >
                    ...
                    >
                        ...
                        {isLoading && (
                            <div className="flex justify-start animate-in fade-in slide-in-from-bottom-2 duration-500 w-full">
                                <div className="bg-slate-900/80 backdrop-blur-md rounded-3xl px-6 py-4 shadow-xl border border-slate-800 flex flex-col gap-4 w-full max-w-2xl">
                ...
                <div className="w-full max-w-3xl px-4 pointer-events-auto relative group">
                    ...
                    {!isChatExpanded && activeComponentCode && !isFlipped && (
                        <button
                    ...
                    {!isChatExpanded && activeComponentCode && (
                        <button
                            ...
                            className={`absolute -top-16 ${!isFlipped ? 'right-28' : 'right-16'} bg-slate-900/80 backdrop-blur-xl p-3 rounded-full shadow-lg border border-slate-800 hover:bg-slate-800 hover:border-slate-700 transition-all duration-300 text-slate-400 hover:text-white hover:scale-110 active:scale-95`}
                            title={isFlipped ? "View Component" : "View Code"}
                        >
                            {isFlipped ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
